    ...
    switch($cmd->getName()){
      case "wplist":
        if($issuer->hasPermission("walkingparticles.command") || $issuer->hasPermission("walkingparticles.command.wplist")){
          $issuer->sendMessage("§aList of available particles: §6explode / bubble / splash / water / critical / spell / dripwater / driplava / spore / portal / flame / lava / reddust / heart / ink / snowball / smoke / entityflame / happyvillager / angryvillager / enchantment / instantspell / desblock_ID / item_ID");
          return true;
        }else{
