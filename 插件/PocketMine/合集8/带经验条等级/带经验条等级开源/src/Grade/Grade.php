...
class Grade extends PluginBase implements Listener{
				...
				switch ($args[0]) {
					case "setgrade":
						if (isset($args[1]) == false or isset($args[2]) == false){
							$sender->sendMessage(TextFormat::RED."使用/exp setgrade <目标玩家> <仙阶>");
							return true;
						}
					...
					case "setexp":
						if (isset($args[1]) == false or isset($args[2]) == false){
							$sender->sendMessage(TextFormat::RED."使用/exp setexp <目标玩家> <仙元>");
							return true;
						}
	...
	public function onJoin(PlayerJoinEvent $event){
		...
		$event->setJoinMessage(TextFormat::YELLOW."传说中的".TextFormat::AQUA." 仙阶.".$this->getGrade($player)." ".$this->getTitle($player).TextFormat::GOLD." ".$player->getDisplayName().TextFormat::YELLOW." 来到了镇天星域");
	...
	public function onQuit(PlayerQuitEvent $event){
		$player = $event->getPlayer();
		$event->setQuitMessage(TextFormat::YELLOW."来自传说中的".TextFormat::AQUA." 仙阶.".$this->getGrade($player)." ".$this->getTitle($player).TextFormat::GOLD." ".$player->getDisplayName().TextFormat::YELLOW." 离开了镇天星域");
	}
